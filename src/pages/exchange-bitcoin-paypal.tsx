...
import BitcoinSteps from '../data/webMoneySteps.json';
import benefits from '../data/benefits.json';



const ExchangeBitcoinPaypal = () => {
    return (
        <>
            <Head>
                <title>Exchange Bitcoin to Paypal | HiExchange</title>
            ...
            <main className="text-[#363d71]">
                ...
                <section className="bg-[#363D72] flex flex-col items-start justify-center text-white py-6 px-3">
                    <div className="pt-32 flex flex-col items-center lg:flex-row">
                        <div className="px-4 w-full">
                            <h1 className="font-extrabold text-4xl lg:text-6xl">Exchange Bitcoin to Paypal</h1>
                            <p className="my-9 text-md lg:text-xl lg:w-72">HiExchange offers an easy to use platform and the competitive rates for exchanging Bitcoin to PayPal.</p>
                        </div>

                        <div className="w-full">
                            <Image src="/assets/bitcoin-paypal-hero.svg" className="w-full lg:w-[70%] mx-auto" width={250} height={90} alt="" /> </div>
                    </div>
                ...
                <section className="px-9 py-5 flex flex-col items-center lg:flex-row-reverse lg:gap-5">
                    <div className="w-full">
                        <h1 className="font-bolder text-3xl">Need to Exchange Bitcoin to Paypal?</h1>
                        <p className="pt-2 text-md border-b-2 border-black-200">
                            Despite the wide acceptance for both payment systems, you might
                            need to exchange Bitcoin to PayPal at some point. With a wide
                            variety of e-commerce platforms accepting PayPal, exchange Bitcoin
                            to PayPal to make online payments. Just watch this video guideFor a
                            quick, hassle-free and efficient Bitcoin to PayPal Exchange!
                        </p>

                        <p className="text-blue text-sm pt-7 pb-4">
                            Just watch this video guide for a quick,
                            hassle-free and efficient Bitcoin to Paypal Exchange
                        </p>
                    </div>
                ...
                <section className="px-3">
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="text-2xl text-center font-bold pb-3 lg:text-4xl">
                            To Exchange Bitcoin to PayPal on HiExchange, is just 4 easy steps
                        </h1>
                        <p className="lg:w-[55%] text-center">
                            HiExchange provides PayPal in exchange for different crypto and e-currencies.
                            One of the most popular exchange directions to PayPal is Bitcoin.
                            We have tailored an easy process for your Bitcoin exchange here.
                            It all happens in just 4 steps:
                        </p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-7">{
                        BitcoinSteps.map((step, index) => (
                            <div className="w-full lg:w-[80%] mx-auto mt-9 h-72 px-5 flex flex-col items-center justify-around rounded-2xl border-2 border-black-400" key={index}>
                                ...
                                <Image src={step.icon} width={210} height={120} alt="Exchange Bitcoin to paypal" />
                            </div>
                        ))
                    }</div>
                ...
                <section className="px-3">
                    ...
                    <div className="flex flex-col lg:flex-row">
                        {
                            benefits.map((benefit, index) => (
                                <div className="w-full mt-9 h-72 px-5 gap-7 flex flex-col items-center justify-around rounded-2xl" key={index}>
                                    <Image src={benefit.image} width={150} height={90} alt="Exchange Bitcoin to paypal" />
                    ...
                    <div className=" my-12 gap-5 flex flex-col items-center justify-around gap-4">
                        ...
                        <h3 className="text-3xl font-bolder px-1 lg:text-5xl lg:w-[50%] lg:pt-4 lg:pb-32 text-center">You can exchange your
                            Bitcoin for PayPal instantly</h3>
...
export default ExchangeBitcoinPaypal