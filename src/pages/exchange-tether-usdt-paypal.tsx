...
import UsdtSteps from '../data/webMoneySteps.json';
import benefits from '../data/benefits.json';



const ExchangeUsdtPaypal = () => {
    return (
        <>
            <Head>
                <title>Exchange Usdt to Paypal | HiExchange</title>
            ...
            <main className="text-[#363d71]">
                ...
                <section className="bg-[#363D72] flex flex-col items-start justify-center text-white py-6 px-3">
                    <div className="pt-32 flex flex-col items-center lg:flex-row">
                        <div className="px-4 w-full">
                            <h1 className="font-extrabold text-4xl lg:text-6xl">Exchange Usdt to Paypal</h1>
                            <p className="my-9 text-md lg:text-xl lg:w-72">HiExchange offers an easy to use platform and the competitive rates for exchanging Usdt to PayPal.</p>
                        </div>

                        <div className="w-full">
                            <Image src="/assets/usdt-paypal-hero.svg" className="w-full lg:w-[70%] mx-auto" width={250} height={90} alt="" /> </div>
                    </div>
                ...
                <section className="px-9 py-5 flex flex-col items-center lg:flex-row-reverse lg:gap-5">
                    <div className="w-full">
                        <h1 className="font-bolder text-3xl">Need to Exchange Usdt to Paypal?</h1>
                        <p className="pt-2 text-md border-b-2 border-black-200">
                            Despite the wide acceptance for both payment systems, you might
                            need to exchange Usdt to PayPal at some point. With a wide
                            variety of e-commerce platforms accepting PayPal, exchange USDT
                            to PayPal to make online payments. Just watch this video guideFor a
                            quick, hassle-free and efficient USDT to PayPal Exchange!
                        </p>

                        <p className="text-blue text-sm pt-7 pb-4">
                            Just watch this video guide for a quick,
                            hassle-free and efficient USDT to Paypal Exchange
                        </p>
                    </div>
                ...
                <section className="px-3">
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="text-2xl text-center font-bold pb-3 lg:text-4xl">
                            To Exchange Usdt to PayPal on HiExchange, is just 4 easy steps
                        </h1>
                        <p className="lg:w-[55%] text-center">
                            HiExchange provides PayPal in exchange for different crypto and e-currencies.
                            One of the most popular exchange directions to PayPal is Usdt.
                            We have tailored an easy process for your Usdt exchange here.
                            It all happens in just 4 steps:
                        </p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-7">{
                        UsdtSteps.map((step, index) => (
                            <div className="w-full lg:w-[80%] mx-auto mt-9 h-72 px-5 flex flex-col items-center justify-around rounded-2xl border-2 border-black-400" key={index}>
                                ...
                                <Image src={step.icon} width={210} height={120} alt="Exchange Usdt to paypal" />
                            </div>
                        ))
                    }</div>
                    ...
                    <div className="flex flex-col lg:flex-row">
                        {
                            benefits.map((benefit, index) => (
                                <div className="w-full mt-9 h-72 px-5 gap-7 flex flex-col items-center justify-around rounded-2xl" key={index}>
                                    <Image src={benefit.image} width={150} height={90} alt="Exchange Usdt to paypal" />
...
export default ExchangeUsdtPaypal